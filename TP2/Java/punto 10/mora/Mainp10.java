...
public class Mainp10{
    ...
    public static void main(String [] args) throws Exception{
        ...
        PersonaCenso persona1 = new PersonaCenso("Mora Molina", 21, "f", 1, false, false);
        PersonaCenso persona2 = new PersonaCenso("Claudia Antileff", 52, "f", 1, false, false);

        Familia familia1 = new Familia("casa 34 codigo2341");
        familia1.addPersona(persona1);
        familia1.addPersona(persona2);

        PersonaCenso persona3 = new PersonaCenso("Marta Dominguez", 62, "f", 1, false, false);
        Familia familia2 = new Familia("casa 37 codigo2341");
        familia2.addPersona(persona3);

        PersonaCenso persona4 = new PersonaCenso("Gonzalo Jaime", 52, "m", 1, false, false);
        PersonaCenso persona5 = new PersonaCenso("Rocio Martel", 48, "f", 1, false, false);
        PersonaCenso persona6 = new PersonaCenso("Francisco Jaime", 23, "f", 0,false,false);
        PersonaCenso persona7 = new PersonaCenso("Luz Jaime Martel", 11, "f", 0, false,false);
